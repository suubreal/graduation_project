...
the appropriate train\test folders.
...
def get_train_test_lists(version='01'):
    """
    Using one of the train\test files (01, 02, or 03), get the filename
...
def main():
    """
    Go through each of our train\test text files and move the videos
    to the right place.
    """
