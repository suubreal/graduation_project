...
def main():
    ...
    model = 'lstm'  # see `models.py` for morel
    #saved_model = 'data\\checkpoints\\inception.016-0.52.hdf5'  # None or weights file 고쳐봄!!!
    #saved_model = 'data\\checkpoints\\vgg_128_32_lstm_model.h5'  # None or weights file 고쳐봄!!!
